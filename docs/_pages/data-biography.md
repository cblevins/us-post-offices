...
- A post office says nothing about the number of people living nearby: the New York City post office looks identical on postal maps to a small rural post office serving a fraction as many people. If you're looking for data about the historical populations of US towns and cities, you should look for a source such as the [Alperin-Sheriff/Wikipedia Population dataset](http://creatingdata.us/datasets/US-cities/).
